...
<head>
    ...
    <style>
        body {
            background-image: url("NormalMode.png");
    ...
    <script type="text/javascript" >// sudokuJS v0.4.4
                ...
                *-----------*/
                ...
                var renderBoardCell = function(boardCell, id){
                    ...
                    return "<div class='sudoku-board-cell'>" +
                        ...
                        "<input type='text' pattern='\\d*'  id='input-"+id+"' value='"+val+"'"+maxlength+">" +
...
*/
    ...
    function sb(){
        if(checkSubmit && cheker)
            window.location.assign("congrats2.php")
